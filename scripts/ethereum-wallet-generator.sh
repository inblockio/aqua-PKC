#!/bin/sh
#source https://github.com/topics/ethereum-wallet-generator
...
echo 'GUARDIAN_PRIVATE_KEY='$priv > .env
echo 'GUARDIAN_PUBLIC_KEY='$pub >> .env
echo 'GUARDIAN_ADDRESS='$addr >> .env
